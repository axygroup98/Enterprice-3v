import { LayoutDashboard, Monitor, GitCompareArrows, BarChart3, Plug, Settings, DollarSign, Brain, FileBarChart, ListChecks } from 'lucide-react';

export type Page =
  | 'dashboard' | 'monitor' | 'conciliacao' | 'analisar'
  | 'financeiro' | 'inteligencia' | 'relatorios' | 'execucao'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'execucao',     label: 'Execução',     icon: ListChecks },
